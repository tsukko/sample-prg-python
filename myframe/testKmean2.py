...
from skimage.data import astronaut, moon, coffee
...
# plt.tick_params(labelbottom=False, labelleft=False, labelright=False, labeltop=False, bottom=False,
#                 left=False,
#                 right=False,
#                 top=False)

plt.savefig("test_kmean_coffee.png")
